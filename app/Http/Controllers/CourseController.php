...
class CourseController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        $profile = DB::table('courses')
            ...
            ->select('courses.*', 'degrees._title as degreename', 'universities._name as universityname')
            ->paginate($limit);
     ...
     * @return \Illuminate\Http\Response
     */
    public function universitycourse($id)
    {
        $profile = DB::table('courses')
    ...
    public function graduatecourse($id)
    {
        $profile = DB::table('courses')
            ->join('countries', 'courses._countryid', '=', 'countries.id')
            ->join('degrees', 'courses._degreeid', '=', 'degrees.id')
    ...
    public function undergraduatecourse($id)
    {
        $profile = DB::table('courses')
            ->join('countries', 'courses._countryid', '=', 'countries.id')
            ->join('degrees', 'courses._degreeid', '=', 'degrees.id')
    ...
    public function diplomacourse($id)
    {
        $profile = DB::table('courses')
            ->join('countries', 'courses._countryid', '=', 'countries.id')
            ->join('degrees', 'courses._degreeid', '=', 'degrees.id')
