...
Route::delete('degree/{degree}', [DegreeController::class, 'destroy']);
...
Route::delete('newsfeed/{newsfeed}', [NewsfeedController::class, 'destroy']);
...
Route::delete('recentvisasuccess/{recentvisasuccess}', [RecentVisaController::class, 'destroy']);
...
Route::delete('counter/{counter}', [CounterController::class, 'destroy']);
